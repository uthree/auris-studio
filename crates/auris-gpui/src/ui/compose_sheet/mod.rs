...
//! * `view` — the panel: three columns of elements, and the drag, the write and the save its
//!   buttons hand back. Nothing here can be asserted on, which is why so little is here.
