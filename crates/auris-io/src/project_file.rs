...
mod tests {
    ...
    fn demo_project() -> Project {
        ...
        let source = project.add_audio_source(
            "loop",
            std::path::PathBuf::from("/tmp/loop.wav"),
            96_000,
            48_000.0,
            2,
        );
    ...
    fn ids_handed_out_after_loading_do_not_collide() {
        ...
        // Two tracks, one MIDI clip, one audio source, one audio clip and two effect slots.
        assert_eq!(used.len(), 7, "demo project should hand out 7 ids");
