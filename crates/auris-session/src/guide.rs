...
pub mod singing {
    ...
    //! vocoder. [`SingingBackend`](crate::SingingBackend) is the boundary between either package and the
    //! session: metadata and frame curves go in, mono audio comes out. The session therefore
